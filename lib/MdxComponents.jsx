...
export const mdxComponents = {
  ...
  h1: (props) => <h1 className="font-head font-medium text-primary-text text-5xl/10 my-6" id={`${props.children}`} {...props} />,
  h2: (props) => <h3 className="font-head font-medium text-primary-text text-3xl/8 mb-6 mt-20" id={`${props.children}`} {...props} />,
  h3: (props) => <h4 className="font-head font-medium text-primary-text text-2xl/6 mb-6 mt-10" id={`${props.children}`} {...props} />,
