...
<table className="border border-primary px-4 py-2 text-gray-800">
  ...
  <tbody>
    <tr className="border border-primary px-4 py-2 text-gray-800">
      <td className="border border-primary px-4 py-4 text-primary-text font-medium">"env"</td>
      <td className="border border-primary px-4 py-4 text-secondary-text">Parses variables from a <code>.env</code> file into <code>process.env</code>.</td>
